import numpy as np
from model import MPC_Parameters, setup_robot_model_equations
import time
...
# To stop simulation once goal is reached
...
def main():
    ...
    x0 = np.array([0, 0, np.pi / 3])  # Initial State
